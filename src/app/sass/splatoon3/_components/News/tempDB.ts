...
export const getBulletins = () => [
  ...
  { id: 3, date: '2023-04-05', title: '「스플래툰 3 이벤트 매치」 리포트', href: URLS.NOT_IMPLEMENTED },
  {
    id: 4,
    date: '2023-03-24',
    title: '『스플래툰 3』의 제5회 페스티벌 「미확인 생물 페스티벌」은 4월 1일부터 개최.',
    href: URLS.NOT_IMPLEMENTED,
  },
  { id: 5, date: '2023-03-09', title: '「스플래툰 3 이벤트 매치」 참가팀 발표', href: URLS.NOT_IMPLEMENTED },
  {
    id: 6,
    date: '2023-03-01',
    title: '2023.3.1 『스플래툰 3』의 새로운 시즌 「2023 봄 Fresh Season」이 오늘 개막!',
    href: URLS.NOT_IMPLEMENTED,
  },
];
