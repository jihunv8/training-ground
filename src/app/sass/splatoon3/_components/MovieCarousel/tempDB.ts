...
export const getMovies = (): Movie[] => [
  { id: 0, thumbnail: thumbnail1Image, href: URLS.NOT_IMPLEMENTED, title: '2023 여름 Sizzle Season' },
  { id: 1, thumbnail: thumbnail2Image, href: URLS.NOT_IMPLEMENTED, title: '2022 겨울 Chill Season' },
  { id: 2, thumbnail: thumbnail3Image, href: URLS.NOT_IMPLEMENTED, title: '소개 영상' },
  { id: 3, thumbnail: thumbnail4Image, href: URLS.NOT_IMPLEMENTED, title: '처음 시작하는 스플래툰' },
  { id: 4, thumbnail: thumbnail5Image, href: URLS.NOT_IMPLEMENTED, title: '『스플래툰 3』 영역 배틀 플레이 영상' },
  { id: 5, thumbnail: thumbnail6Image, href: URLS.NOT_IMPLEMENTED, title: '『스플래툰 3』 스플래툰은 어떤 게임일까?' },
  { id: 6, thumbnail: thumbnail7Image, href: URLS.NOT_IMPLEMENTED, title: 'CM2' },
  { id: 7, thumbnail: thumbnail8Image, href: URLS.NOT_IMPLEMENTED, title: 'CM' },
  { id: 8, thumbnail: thumbnail9Image, href: URLS.NOT_IMPLEMENTED, title: 'Nintendo Direct 2022.8.10' },
  { id: 9, thumbnail: thumbnail10Image, href: URLS.NOT_IMPLEMENTED, title: '「새먼 런 NEXT WAVE」 트레일러' },
  { id: 10, thumbnail: thumbnail11Image, href: URLS.NOT_IMPLEMENTED, title: 'Nintendo Direct 2021.9.24' },
];
